...
public class LoginSteps extends PageSteps {
    ...
    public void haceClickEnElMenuLateral() {
        LoginService.clickBtnMenu();
    }

    @And("hace click en cerrar sesion")
    public void haceClickEnCerrarSesion() {
        LoginService.clickCerrarSesion();
    }

    @Then("se verifica que cierra sesion exitosamente")
    public void seVerificaQueCierraSesionExitosamente() {
        LoginService.verificarLogout();
    }

    @And("hace click en confirmar")
    public void haceClickEnConfirmar() {
        LoginService.confirmaLogout();
    }
}
